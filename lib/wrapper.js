...
module.exports.wrapExports = function wrapExports(name, obj, options){
  ...
  module.exports.wrapFunctions(name, obj, -1, hooks);
...
module.exports.wrapFunctions = function wrapFunctions(name, obj, protoLevel, hooks){
  ...
  util.iterateOwnProperties(obj, function(key){
    ...
    if (util.isFunction(desc.value)) {
      ...
      self.wrapFunctions(name, desc.value, 0, hooks);
    }
  });
  ...
  if (protoLevel != 0){
    ...
    self.wrapFunctions(name, proto, protoLevel, hooks);
  }
}