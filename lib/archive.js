...
var FUDGE = Math.floor(2000 * Math.random())
...
Archiver.prototype.start = function start() {
  ...
  if (this.interval || this.options.skipArchive || !this.options.archiveInterval) {
    return;
  }
  // Send out the first aggregation after 250 millis, then use the interval.
