...
function acquireAwsCredentials() {
  ...
  // TODO how does this correspond to a user? What if multiple jobs on same host
  var options     = {
...
function doArchive(json) {
  ...
  //     });
  //     aggregate.startTracing(); // TODO possible race condition w/ surrounding start/stop
  //   } else {
...
function configure(options){
  ...
  if (options.accountKey && options.hostname && options.archiveHost && options.archivePort) {
    initAwsCredentials();
  }
}
